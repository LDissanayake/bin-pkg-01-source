"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[563],{
...
const flushSyncImpl = external_ReactDOM_[FLUSH_SYNC];
const USE_ID = "useId";
...
function dist_RouterProvider(_ref) {
  ...
  let routerFuture = external_React_.useMemo(() => ({
    v7_relativeSplatPath: router.future.v7_relativeSplatPath
  ...
  return /*#__PURE__*/external_React_.createElement(external_React_.Fragment, null, /*#__PURE__*/external_React_.createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator,
    future: routerFuture
  }, state.initialized || router.future.v7_partialHydration ? /*#__PURE__*/external_React_.createElement(MemoizedDataRoutes, {
    routes: router.routes,
    future: router.future,
    state: state
  }) : fallbackElement))))), null);
...
const MemoizedDataRoutes = /*#__PURE__*/external_React_.memo(dist_DataRoutes);
